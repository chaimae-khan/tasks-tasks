        ...
        return {
            colors: {
                ...
                theme: {
                    ...
                    success: e.getPropertyValue("--success") ? e.getPropertyValue("--success").replace(" ", "") : "#C6EB54",
...
var Dropzones = function() {
    ...
    ProgressCircle = (Popover = function() {
        ...
        e.length && e.each(function() {
            var e, t, a, n, o, i;
            t = (e = $(this)).data().progress, a = e.data().text ? e.data().text : "", n = e.data().textclass ? e.data().textclass : "progressbar-text", o = e.data().color ? e.data().color : "primary", i = {
    ...
    WpxSwiper = function() {
        ...
        $(document).ready(function() {
            e.length && e.each(function(e, t) {
                var a, n, o, i, s, r, l, d, c, u, p, f, g, h, m, v, y, b, w, C, k, x;
                n = (a = $(t)).find(".swiper-container"), o = a.find(".swiper-pagination"), i = a.find(".swiper-button-next"), s = a.find(".swiper-button-prev"), r = n.data("swiper-effect") ? n.data("swiper-effect") : "slide", l = n.data("swiper-direction") ? n.data("swiper-direction") : "horizontal", d = n.data("swiper-initial-slide") ? n.data("swiper-initial-slide") : 0, c = !!n.data("swiper-autoheight") && n.data("swiper-autoheight"), u = !!n.data("swiper-autoplay") && n.data("swiper-autoplay"), p = !!n.data("swiper-centered-slides") && n.data("swiper-centered-slides"), f = n.data("swiper-pagination-type") ? n.data("swiper-pagination-type") : "bullets", g = (g = n.data("swiper-items")) || 1, h = (h = n.data("swiper-sm-items")) || g, m = (m = n.data("swiper-md-items")) || h, v = (v = n.data("swiper-lg-items")) || m, y = (y = n.data("swiper-xl-items")) || v, b = (b = n.data("swiper-space-between")) || 0, w = (w = n.data("swiper-sm-space-between")) || b, C = (C = n.data("swiper-md-space-between")) || w, k = (k = n.data("swiper-lg-space-between")) || C, x = (x = n.data("swiper-xl-space-between")) || k, new Swiper(n, {
                    pagination: {
                        el: o,
                        clickable: !0,
                        type: f
        ...
        e.length && e.each(function() {
            ...
            e = $(this), t = {
                ...
                series: [{
                    ...
                    name: "Expenses",
                    data: [9, 22, 19, 10, 9, 10, 3, 4]
                }],
                colors: ["#C6EB54", "#273444"],
                xaxis: {
                    labels: {
                        format: "MMM",
                        style: {
            ...
            }, e.data().dataset, e.data().labels, e.data().color, e.data().height, e.data().type, a = new ApexCharts(e[0], t), setTimeout(function() {
                a.render()
            }, 300)
        })
    }(),
    DeclarationChart = function() {
        var e = $("#apex-declaration");
        e.length && e.each(function() {
            var e, t, a;
            e = $(this), t = {
                chart: {
    ...
    AccountingChart = function() {
        var e = $("#apex-accounting");
        e.length && e.each(function() {
            ! function(e) {
                var t = {
                        chart: {
    ...
    invoicesdonut = function() {
        var e = $("#apex-donut");
        e.length && e.each(function() {
            ! function(e) {
                e.data().dataset, e.data().labels, e.data().color, e.data().height, e.data().type;
                var t = new ApexCharts(e[0], {
                    chart: {
                        type: "donut",
                        width: "100%",
                        height: 300
                    ...
                    //series: [25, 15, 30, 5, 25],
                    series: [60, 40, 60, 30, 40],
                    labels: ["Invoices Accounted", "Invoices not counted", "Partially Paid", "Paid", "Overdue"],
                    colors: ["#464242", "#2A2A2A", "#C6EB54", "#000", "#61AB01"],
                    plotOptions: {
                        pie: {
                          donut: {
                            labels: {
        ...
        e.length && e.each(function() {
            ! function(e) {
                var t = {
                        ...
                        series: [{
                            name: "$",
                            data: [40, 30, 100, 90, 20, 40, 30, 100, 90, 20, 90, 20]
                        }],
                        xaxis: {
                            labels: {
                                format: "MMM",
                            ...
                            type: "datetime",
                            categories: ["1/1/2019", "2/1/2019", "3/1/2019", "4/1/2019", "5/1/2019", "6/1/2019", "7/1/2019", "8/1/2019", "9/1/2019", "10/1/2019", "11/1/2019", "12/11/2019"]
                        },
                        yaxis: {
                            labels: {
                                style: {
